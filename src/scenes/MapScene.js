  ...
  tryInteract() {
    ...
    this.npcArray.forEach(npc => {
      ...
      if (npc === this.npc_samuel) {
        transitionData = { npc: 'samuel', pointsNeeded: 300, rounds: 3 };
      ...
      // Disable the interact key to prevent further interactions during dialogue
      this.input.keyboard.enabled = false;

      // Launch the Dialogos scene with the transition data
      this.scene.launch('Dialogos', transitionData);
