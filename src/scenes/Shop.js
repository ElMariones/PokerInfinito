...
export default class ShopScene extends Phaser.Scene {
    ...
    create() {
        ...
        // Title for the shop
        this.add.text(width / 2, 50, "Tienda de jokers", {font: '24px RetroFont', fill: '#fff', stroke: '#000000', strokeThickness: 2 }).setOrigin(0.5);

        // Create the Inventory helper and display player's coin count
        this.inventory = new Inventory(this);
        this.coinText = this.add.text(20, 20, `Dinero: ${this.registry.get('coins')}`, {font: '18px RetroFont', fill: '#fff', stroke: '#000000', strokeThickness: 2  });
        ...
        jokerOptions.forEach((joker, index) => {
            ...
            if (this.inventory.hasJoker(id)) {
                ...
                const fullInventoryButton = new UIButton(this, buttonX, buttonY, "Lleno", "green", () => {});
                fullInventoryButton.disable();
            } else {
                // Create a Buy button using UIButton with green type
                const buyButton = new UIButton(this, buttonX, buttonY, "Compra", "green", () => {
