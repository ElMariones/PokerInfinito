const Jokers = [
  ...
  { id: 19, name: "El Barón", image: "baronJoker", effect: "if (cards.some(card => card.rank === 'rey')) {context.multiplier *= 1.5}", price: 360, description: "Multiplicador x1.5 si juegas reyes." },
  { id: 20, name: "La Fotografía", image: "fotografiaJoker", effect: "if (cards.some(card => card.rank === 'rey' || card.rank === 'sota' || card.rank === 'caballo')) { context.multiplier *= 2 }", price: 400, description: "Multiplicador x2 si juegas una figura." },
  { id: 21, name: "El Juglar", image: "juglarJoker", effect: "if (cards.some(card => card.rank === 'rey' || card.rank === 'caballo')) context.multiplier *= 2", price: 420, description: "Multiplicador x2 si juegas un rey o un caballo." },
  ...
  { id: 33, name: "La Cromos", image: "cromosJoker", effect: "context.multiplier += 1.5 * ownedJokers.length", price: 400, description: "Multiplicador +1.5 por cada joker en tu mano." },
